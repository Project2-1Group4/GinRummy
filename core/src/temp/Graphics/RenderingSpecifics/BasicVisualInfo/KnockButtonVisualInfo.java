...
public class KnockButtonVisualInfo extends VisualInfo {
    ...
    public void render(SpriteBatch batch, Style style) {
        ...
        font.draw(batch,"Knock",p[0],pos.y);

        width = Gdx.graphics.getWidth()*0.1f;
        height = Gdx.graphics.getHeight()*0.05f;
        pos.x = (Gdx.graphics.getWidth()-2*width-20)/2;
